    ...
    >
      ...
      <div className="hidden xl:block">
        <div className="overflow-hidden rounded-[1.75rem] border border-white/10 bg-white/[0.04] shadow-[0_12px_35px_rgba(0,0,0,0.24)] backdrop-blur-xl">
          ...
          <div className="relative overflow-hidden px-5 pt-2 pb-10">
            ...
            <div className="relative flex w-full justify-center">
              <div className="relative rounded-[2rem] border border-white/10 bg-[#07111f]/70 px-4 pt-4 pb-14 backdrop-blur-xl">
