      ...
      <div className="mx-auto max-w-4xl">
        ...
        <div className="mb-8 rounded-[1.75rem] border border-emerald-200 bg-emerald-50/70 p-5 shadow-sm">
          ...
          <ul className="mt-3 space-y-2 text-sm leading-6 text-slate-700">
            ...
            <li>• Total avgift är 170 kr och ska Swishas med din unika kod.</li>
        ...
        <div className="space-y-6">
          ...
          <section className="rounded-[1.75rem] border border-slate-200 bg-white p-6 shadow-sm">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-700 md:text-base">
              När deadline passerat låses systemet automatiskt. Det lag du har sparat
              i appen vid den tidpunkten är det tips som gäller.
            </p>
            <p className="mt-3 text-sm leading-7 text-slate-700 md:text-base">
              Det går alltså <strong>inte</strong> att skicka in tips via mail i år,
              och inga manuella ändringar görs efter deadline.
            </p>
          </section>
          ...
          <section className="rounded-[1.75rem] border border-slate-200 bg-white p-6 shadow-sm">
            ...
            <div className="mt-4 grid gap-4 md:grid-cols-2">
              <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                ...
                <ul className="mt-3 space-y-2 text-sm text-slate-700">
                  ...
                  <li>
                    • Total kostnad: <strong>170 kr</strong>
                  </li>
                </ul>
              </div>
              ...
              <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                ...
                <p className="mt-3 text-sm leading-6 text-slate-700">
                  Betalning sker via Swish och ska märkas med din <strong>unika kod</strong>,
                  som visas på din sida i appen.
                </p>
              </div>
            </div>
            ...
            <div className="mt-4 rounded-2xl border border-amber-200 bg-amber-50 p-4 text-sm leading-6 text-amber-900">
              ...
              poäng och tas bort från leaderboard.
            </div>
          </section>
          ...
          <section className="rounded-[1.75rem] border border-slate-200 bg-white p-6 shadow-sm">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-700 md:text-base">
              För dig som vill ha hjälp på travspråkig nivå finns knappen{" "}
              <strong>”Adde Boy”</strong>.
            </p>
            <p className="mt-3 text-sm leading-7 text-slate-700 md:text-base">
              När du klickar på den fylls hela gruppspelet i automatiskt i sann{" "}
              <strong>Harry Boy-anda</strong>. Det är alltså ett slumpat tips som kan
              användas som grund eller köras rakt av.
            </p>
          </section>
          ...
          <section className="rounded-[1.75rem] border border-slate-200 bg-white p-6 shadow-sm">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-700 md:text-base">
              Nytt för i år är att det går att skapa egna kompisligor i appen.
            </p>
            ...
            <div className="mt-4 rounded-2xl border border-slate-200 bg-slate-50 p-4">
              ...
              <ul className="mt-3 space-y-2 text-sm leading-6 text-slate-700">
                ...
                <li>• Det innebär att alla måste ha betalat avgiften</li>
              </ul>
            </div>

            <div className="mt-4 rounded-2xl border border-amber-200 bg-amber-50 p-4 text-sm leading-6 text-amber-900">
              Deltagare som inte har betalat kommer inte visas med poäng och tas
              bort från både kompisligor och huvudligan efter deadline.
            </div>
          ...
          <section className="rounded-[1.75rem] border border-slate-200 bg-white p-6 shadow-sm">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-700 md:text-base">
              Prisstegen gäller även i år och sponsring finns fortsatt med i
              upplägget.
            </p>
            <p className="mt-3 text-sm leading-7 text-slate-700 md:text-base">
              Exakta nivåer fastställs beroende på antal deltagare.
            </p>
          </section>
          ...
          <section className="rounded-[1.75rem] border border-slate-200 bg-white p-6 shadow-sm">
            ...
            <ul className="mt-4 space-y-2 text-sm leading-6 text-slate-700">
              ...
              <li>• Inga mail-inlämningar</li>
              <li>• Deadline: 10 juni 23:00</li>
              <li>• Betalning krävs för att delta</li>
              <li>• Swish märks med unik kod</li>
              <li>• Obetalda tas bort efter deadline</li>
          ...
          <section className="rounded-[1.75rem] border border-emerald-200 bg-emerald-50/70 p-6 shadow-sm">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-700 md:text-base">
              Du tippar, sparar, betalar – och sedan låser systemet allt vid
              deadline.
            </p>
